...
// Rooted at "/" so the header also works from the article pages under /insights.
const links = [
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
        <Link href="/#top" className="rounded-full border border-white/10 bg-black/50 px-3 py-2 backdrop-blur-xl">
